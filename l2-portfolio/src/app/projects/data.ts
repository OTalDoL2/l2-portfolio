...
export const myProjects: Project[] = [
    {
        ...
        slug: "rastros",
        title: "Rastros 2028",
        subtitle: ["Edição Especial Anima Recife", "Desenvolvido como projeto final, referente às disciplinas de CJD (Cultura de Jogos de Digitais) e PI (Projeto Integrado)."],
